                        ...
                        <div class="col-sm-12">
                           <ul class="pt-contact pt-2">
                              <li>
                                 ...
                                 <span class="text-white"> No.6,Bank Staff Colony 4th Cross, Madhakottai Road,
                                    Thanjavur-5 </span>
                              </li>
                              <li class="pt-3">
                              ...
                              <li class="pt-3">
                                 <a href="mailto:raniconstruction.ah@gmail.com"><i class="fa fa-envelope"></i><span class="text-white">raniconstruction.ah@gmail.com</span></a>
                              </li>
                           </ul>
                        </div>
                     </div>
      ...
      <div class="pt-copyright-footer">
         <div class="container">
            <div class="row pb-3 pt-4">
               <div class="col-md-6">
                  <span class="pt-copyright"><a href="javascript:void(0)"> Copyright 2023 Rani Construction.All
